...
export const SEASON_AWARDS: AwardDefinition[] = [
  ...
  special("Teamwork", "Baron Society", "Most team Barons secured per team game.", "team", "perGame", "Barons/game", { totalUnit: "Barons", totalFallback: true }),
  ...
  special("Best of Champions", "Best of Champion", "One unique played champion assigned to each player, maximizing coverage before champion-specific performance.", "player", undefined, "", { partition: "league" }),
  ...
  ...([
    ...
    ["Four Horsemen", "Most quadra kills per game", "quadra_kills", "quadra kills/game", "quadra kills"],
