...
export const MUTATIONS: Mutation[] = [
  ...
  },
  {
    ...
    look: "Violet fog drifting up from the bottom of the card, a cold vignette, and a flicker every few seconds as if something behind the art moved.",
  ...
  },
  {
    ...
    look: "The card's edges bleed into darkness, pinprick stars drift across the art, and a rift line of white light opens and closes across the middle.",
