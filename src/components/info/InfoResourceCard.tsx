...
export default function InfoResourceCard({ label, description, href }: Props) {
  return (
    ...
    >
      ...
      <a
        className="mt-6 inline-flex w-fit items-center rounded-full border border-coral/50 bg-coral/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em] text-coral transition hover:bg-coral/20 hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-coral"
        href={href}
