...
const CHIP =
  "rounded-full border border-border-subtle bg-surface px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-muted";
const GOLD_CHIP =
        ...
        >
          <div className="my-auto flex flex-col items-center gap-3" onClick={(event) => event.stopPropagation()}>
            <button
              ...
              className="self-end rounded-full border border-border-strong bg-surface px-2.5 py-1 text-xs font-bold text-muted transition hover:border-action-text hover:text-action-text"
            >
              ✕
            </button>
            ...
            {shown ? (
              ...
              <p className="w-72 rounded-xl border border-border-subtle bg-surface p-6 text-center text-sm text-muted">
