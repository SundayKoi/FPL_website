...
export default function ChampionDatum({ champion, tone = "neutral", label, testId }: { champion: string | null; tone?: ChampionDatumTone; label?: string; testId?: string }) {
  ...
  const toneClass = tone === "ban" ? "border-red-400/60 bg-red-950/30" : tone === "pick-blue" ? "border-cyan/50 bg-cyan/10" : tone === "pick-red" ? "border-coral/60 bg-coral/10" : "border-line bg-navy/60";
