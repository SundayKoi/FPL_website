...
export default function UpcomingDraftCard({ draft }: { draft: Draft }) {
  ...
  return (
    <article className="card-brand overflow-hidden border-gold/30 bg-gradient-to-br from-gold/10 via-surface to-surface p-5 sm:p-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-sm text-muted">Draft start · {formatEasternDateTime(startsAt)}</p>
        </div>
