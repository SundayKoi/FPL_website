    ...
    >
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        <article className="relative overflow-hidden rounded-lg border border-border-subtle bg-gradient-to-br from-surface to-canvas p-5">
          ...
          <p className="mt-2 max-w-lg text-sm leading-6 text-muted">{awards.playerOfWeek.detail}</p>
          <div className="mt-5 flex items-center gap-3">
            <span className="flex h-11 w-11 items-center justify-center rounded-full border border-cyan/60 bg-canvas font-mono text-xs font-bold text-cyan">
            ...
            <div>
              ...
              <p className="text-xs uppercase tracking-[0.12em] text-muted">{winnerMeta(awards.playerOfWeek)}</p>
            </div>
          </div>
