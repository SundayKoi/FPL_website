...
export default function BoxScoreUnavailable({ league }: { league: string }) {
  return (
    <main className="bg-hash mx-auto flex w-full max-w-[900px] flex-1 flex-col items-center justify-center px-4 py-16 text-center text-white sm:px-6">
      <span className="label-dash">{league} box score</span>
      <h1 className="type-display mt-3 text-4xl">Box Score warming up</h1>
