...
**Goal:** Update the shared header so Home is represented only by the logo, Sign Up is nested under Info, and Betting plus the external Draft League site are nested under a new Premium dropdown.
...
- [ ] **Step 2: Add state and IDs for the active dropdown**
...
- [ ] **Step 3: Add outside-click cleanup**
...
- [ ] **Step 4: Render the grouped menu buttons and links**
...
- [ ] **Step 5: Preserve active-route behavior**
...
- [ ] **Step 6: Run the focused test suite and fix only implementation issues**
